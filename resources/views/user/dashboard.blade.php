...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1 class="m-0">Dashboard de {{ auth()->user()->empresa->razonSocial }}</h1>
    </div>
    <div class="col-sm-6">
...
<div class="row">
    <div class="col-lg-6">
        <div class="small-box bg-info">
            <div class="inner">
                <h3>{{ auth()->user()->empresa->ReporteVentas()->count() }}</h3>
    ...
    <div class="col-lg-6">
        <div class="small-box bg-success">
            <div class="inner">
                <h3>{{ number_format(auth()->user()->empresa->ReporteVentas()->sum('Total'), 2) }}</h3>
                <p>Total Ventas (S/)</p>
            </div>
            <div class="icon">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach(auth()->user()->empresa->ReporteVentas()->latest()->take(5)->get() as $venta)
                            <tr>
