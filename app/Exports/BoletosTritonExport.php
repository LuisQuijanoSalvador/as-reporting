...
class BoletosTritonExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents, WithDrawings
{
    protected $user;
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $sheet->setCellValue("L{$totalRow}", "Totales");
                ...
                foreach (['M', 'N', 'O', 'P', 'Q', 'R', 'S', 'T'] as $col) {
                ...
                $numericColumns = ['M', 'N', 'O', 'P', 'Q', 'R', 'S', 'T'];
